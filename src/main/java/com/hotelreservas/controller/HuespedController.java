...
public class HuespedController {
    ...
    public ResponseEntity<List<HuespedResponseDTO>> listarTodos() {
        List<HuespedResponseDTO> huespedes = huespedService.listarTodos().stream()
    ...
    /**
     * Devuelve el registro de Huesped asociado al usuario autenticado.
     * Permitido para ADMIN y HUESPED (cada usuario solo puede ver el suyo).
     */
    @GetMapping("/me")
